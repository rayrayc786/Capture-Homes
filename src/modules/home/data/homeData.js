export const homeData = {
  ...
  editorial: {
    ...
    title: "Thoughts on light, shadow, and digital permanence.",
    articles: [
      {
        id: 1,
        tag: "Theory",
        date: "Oct 2024",
        title: "The Future of Digital Brutalism",
        description: "Exploring why radical simplicity and honest materials are returning to the web.",
      ...
      },
      {
        ...
        tag: "Curation",
        date: "Sep 2024",
        title: "Shadow & Light: A Curation Study",
        description: "How we use tonal depth to guide the user's eye without explicit UI elements.",
      ...
      },
      {
        ...
        description: "Defining breathable design as a luxury material in the digital economy.",
